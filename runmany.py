...
from agents import your_agent
from game import apply_move, check_winner
def play_game(agent_x, agent_o, board_size=5) -> float:
    """
...
def evaluate_agent(agent_fn, opponent_fn, games: int = 100, board_size: int = 5) -> float:
    """
